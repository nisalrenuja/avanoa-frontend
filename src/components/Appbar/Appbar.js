  ...
  return (
    <div className="appbar">
      <div className={`appbar_wrapper ${selS}`}>
        ...
        <button className={sec1} id="turnoffbtn" onClick={pauseWebgazer}>
          Turn Off
        </button>
        <button className={sec2} id="turnonbtn" onClick={resumeWebgazer}>
          Turn On
        </button>
        <div className="siren">
          {/* <button className={this.state.select1}>Siren</button> */}
          <button className={sec3} id="sirenbtn" onClick={playAudio}>
            Siren
          </button>
        </div>
        {/* avatar */}
        ...
        <button className={sec5} id="logoutbtn" onClick={handleClick}>
          Logout
        </button>
      </div>
    </div>
